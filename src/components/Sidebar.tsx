...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="hidden md:flex flex-col w-[260px] bg-slate-50 text-black min-h-screen flex-shrink-0 relative overflow-hidden rounded-r-3xl my-2 ml-2 shadow-2xl">
      {/* Brand Header */}
      ...
      {user && (
        <div className="mx-4 mb-8">
          <div className="bg-white/50 rounded-2xl p-3 flex items-center justify-between border border-white/5 cursor-pointer hover:bg-white transition-colors">
            <div className="flex items-center space-x-3">
              ...
              <div className="overflow-hidden">
                <p className="text-[10px] text-black">Hello,</p>
      ...
      <div className="mt-auto p-4 mb-4">
        <div className="bg-white/60 rounded-2xl p-4 border border-white/5 relative overflow-hidden group hover:bg-white transition-colors cursor-pointer">
