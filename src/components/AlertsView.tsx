    ...
    <div className="max-w-4xl w-full mx-auto space-y-6 pb-20 md:pb-6">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-black">Campus Alerts & Official Notices</h2>
        ...
        <div className="text-xs text-black bg-slate-50 px-3 py-1.5 rounded-xl border border-slate-200 flex items-center gap-1.5">
      ...
      <div className="flex items-center space-x-2 overflow-x-auto pb-1 text-xs font-semibold">
        <span className="text-black flex items-center gap-1 pl-1">
          ...
          return (
            <div
              ...
              className={`p-5 rounded-2xl border transition-all shadow-sm space-y-3 ${
                !alert.isRead
                  ? 'bg-white/95 border-emerald-500/40 shadow-emerald-500/5'
                  : 'bg-slate-50/80 border-slate-200 text-black opacity-90'
              }`}
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <div className="flex items-center space-x-2 flex-wrap gap-y-1">
                      <span className="text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded bg-slate-50 text-black border border-slate-200">
                        {alert.category}
                      </span>
                      {isHigh && (
                    ...
                    <h3 className="text-base font-bold text-black mt-1">{alert.title}</h3>
                  </div>
                </div>
                ...
                <button
                  ...
                  className={`text-[11px] font-semibold px-2.5 py-1 rounded-lg border transition-colors flex items-center gap-1 ${
                    alert.isRead
                      ? 'bg-slate-50 text-black border-slate-200 hover:text-white'
              ...
              <p className="text-xs text-black leading-relaxed pl-12">{alert.content}</p>

              <div className="pt-2 pl-12 flex items-center justify-between text-[11px] text-black border-t border-slate-200">
